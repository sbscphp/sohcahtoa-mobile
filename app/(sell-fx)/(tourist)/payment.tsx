...
export default function PaymentScreen() {
    ...
    const handleSent = () => {
        router.push('/(sell-fx)/(tourist)/payment-success');
    };
                ...
                <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.infoBox}>
                        ...
                        <Text style={styles.infoText}>
                            Once payment is confirmed, your foreign exchange will be available for pickup at your selected location. Please bring your passport and visa documents.
                        </Text>
                    </View>
