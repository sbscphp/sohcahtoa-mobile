...
export default function PaymentScreen() {
    ...
    const handleSent = () => {
        router.push('/(sell-fx)/(resident)/payment-success');
    };
            ...
            >
                <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.amountContainer}>
                        ...
                        <Text style={styles.amountValue}>₦ 1,500,000.00</Text>
                    </View>
                    ...
                    <View style={styles.infoBox}>
                        ...
                        <Text style={styles.infoText}>
                            Once payment is confirmed, your foreign exchange will be available for pickup at your selected location. Please bring your passport and transaction ID.
                        </Text>
                    </View>
