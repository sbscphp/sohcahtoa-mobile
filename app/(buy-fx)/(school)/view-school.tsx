...
import { commonDocTypeLabels, getTransactionDocuments, formatDate, formatTime, formatTimeWithSeconds, formatCurrency, getCurrencySymbol, mapApiStatusToViewStatus, isPaymentRequired, getTransactionMessage } from '@/utils/helpers';
...
export default function ViewSchoolFeesScreen() {
    ...
    const getMessage = () => getTransactionMessage(tx, 'school fees payment request');
